package com.study.core.utils.aes;
...
//            System.out.println("数据块位数(byte)：" + cipher.getBlockSize());
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        // 输出内容    加密后 hex返回结果:BAE996B948645DA06922BE240FF3FEA1
        System.out.println("加密后 hex返回结果:" + encodeWordHex);
        // 输出内容    加密后 base64返回结果:uumWuUhkXaBpIr4kD/P+oQ==
        System.out.println("加密后 base64返回结果:" + encodeWordBase64);
    }
}
