package com.study.core.business.wechat.server.controller;

import cn.xluobo.config.wechat.cp.WechatCpConfiguration;
...
@RequestMapping("/server/check/wechat/cp/js/{corpId}/{agentId}")
