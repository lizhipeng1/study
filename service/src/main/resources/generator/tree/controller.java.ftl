 ...
 */
@RestController
@RequestMapping("/api/${table.moduleName}/${table.businessName}")
public class ${fileNameInfo.CONTROLLER} {
    ...
    public APIResponse treeSelect() {
        return ${firstLowerEntityName}Service.treeSelect();
    }
    ...
    public APIResponse detailById(@PathVariable("${pkColumn}") Long ${pkColumn}) {
     ...
     * @return
     */
    @PostMapping("/add/add${table.className}")
     ...
     * @return
     */
    @PutMapping("/update/update${table.className}")
    ...
    public APIResponse deleteById(@PathVariable("${pkColumn}s") Long[] ${pkColumn}s) {
